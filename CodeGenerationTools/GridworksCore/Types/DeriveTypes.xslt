        ...
        <FileSet>
            <FileSetFiles>
                ...
                <xsl:variable name="local-alias" select="AliasRoot" />
                    ...
                    <FileSetFile>
                                <xsl:element name="RelativePath"><xsl:text>../../../src/gwatn/schemata/</xsl:text>
...
<xsl:text>
from gwatn.enums import </xsl:text>
<xsl:call-template name="nt-case">

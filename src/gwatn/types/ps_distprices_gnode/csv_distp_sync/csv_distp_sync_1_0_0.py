...
from gwatn.types.ps_distprices_gnode.r_distp_sync.r_distp_sync_1_0_0 import (
    Payload as RDistpSync100Payload,
)
from gwatn.types.ps_distprices_gnode.r_distp_sync.r_distp_sync_1_0_0 import (
    R_Distp_Sync_1_0_0,
)
...
class Payload(NamedTuple):
    ...
    def passes_derived_validations(self) -> Tuple[bool, Optional[List[str]]]:
        is_valid = True
        errors = []
        if self.MpAlias != "csv.distp.sync.1_0_0":
            is_valid = False
            errors.append(
                f"Payload requires MpAlias of 'csv.distp.sync.1_0_0', not {self.MpAlias}."
            )
...
class Csv_Distp_Sync_1_0_0:
    mp_alias = "csv.distp.sync.1_0_0"
    ...
    def paired_rabbit_payload(self, agent) -> RDistpSync100Payload:

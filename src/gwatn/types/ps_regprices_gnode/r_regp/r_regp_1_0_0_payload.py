"""Payload for r.regp.1_0_0"""
from typing import Dict
from typing import List
from typing import Optional
from typing import Tuple

from gwatn.types.ps_regprices_gnode.r_regp.r_regp_1_0_0_payload_base import PayloadBase
...
class Payload(PayloadBase):
    def is_valid(self) -> Tuple[bool, Optional[List[str]]]:
        ...
        if len(errors) > 0:
            errors.insert(0, "Errors making r.regp.1_0_0 msg.")

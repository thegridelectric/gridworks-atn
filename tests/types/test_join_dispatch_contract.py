"""Tests join.dispatch.contract type, version 000"""
import json
...
def test_join_dispatch_contract_generated() -> None:
    ...
    t = Maker(
        ...
        dispatch_contract_app_id=gtuple.DispatchContractAppId,
    ...
    d2 = dict(d, DispatchContractAppId="5.1")
